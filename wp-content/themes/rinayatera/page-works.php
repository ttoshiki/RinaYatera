				...
				<div class="photos-inner">
					<?php
						...
						<li class="photos photos-thumbnail moreLoad last" id="moreLoad__wedding">
							<button value="wedding" class="moreLoadButton" id="moreLoadButton__wedding"><span
									class="moreLoadButton__text">CLICK<br>FOR MORE</span></button>
						</li>
					</ul>
					<?php
				...
				<div class="photos-inner__second-category">
					<?php
						...
						<li class="photos photos-thumbnail my-effect moreLoad" id="moreLoad__family">
							<button value="family" class="moreLoadButton" id="moreLoadButton__family"><span
									class="moreLoadButton__text">CLICK<br>FOR MORE</span></button>
						</li>
					</ul>
					<?php
		...
		<section>
			<div class="inner text-center">
				...
				<div class="go-to-plan_btn__outer">
					<a href="<?php echo home_url('/plan'); ?>#plan-wedding" class="go-to-plan_btn__sentense">see more
						details</a>
				</div>
